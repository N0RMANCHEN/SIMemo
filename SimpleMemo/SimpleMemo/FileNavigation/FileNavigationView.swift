...
private struct ViewStyle {
    ...
    /// 导航背景颜色
    static let backgroundColor = AppColors.color02
    
    /// 分隔线颜色
    static let dividerColor = AppColors.color03
    
    /// 文件项文字颜色
    static let fileItemTextColor = AppColors.color05
    
    /// 文件项图标颜色
    static let fileItemIconColor = AppColors.color04
