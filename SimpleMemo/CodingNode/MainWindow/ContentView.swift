...
struct ViewParameters {
    ...
    static let minNavigationWidth: CGFloat = 150    
    /// 代码画布的最小宽度
    /// 这个值确保代码画布有足够的空间显示代码
    static let minCodeCanvasWidth: CGFloat = 250
    ...
    /// 主背景颜色
    /// 用于整个应用的主要背景色
    static let mainBackgroundColor = AppColors.black0
    
    /// 侧边栏背景颜色
    /// 用于文件导航栏的背景色
    static let sidebarBackgroundColor = AppColors.black1
    
    /// 节点画布背景颜色
    /// 用于中央节点画布区域的背景色
    static let nodeCanvasBackgroundColor = AppColors.black1
    
    /// 代码画布背景颜色
    /// 用于右侧代码预览区域的背景色
    static let codeCanvasBackgroundColor = AppColors.black0
    
    /// 分隔线颜色
    /// 用于可拖动分隔线的颜色
    static let dividerColor = AppColors.black1
}
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            GeometryReader { geometry in
                HStack(spacing: 0) {
                    // 文件导航视图
                    FileNavigationView(title: "File Navi")
