...
private struct InputText {
    /// 标题文本
    static let title = "CODE PREVIEW"
    
    /// 未选中节点时的提示文本
    static let placeholder = "Select a node to view code"
}
...
private struct ViewStyle {
    ...
    /// 标题背景的颜色
    static let titleBackgroundColor = AppColors.black1
    
    /// 代码文本的颜色
    static let codeColor = AppColors.white0
    
    /// 代码预览区域的背景颜色
    static let codeBackgroundColor = AppColors.black0
    
    /// 未选中节点时显示的提示文本颜色
    static let placeholderColor = AppColors.gray1
}
