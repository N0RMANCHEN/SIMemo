...
struct NodeViewStyle {
    ...
    // 颜色设置
    static let backgroundColor = AppColors.color01
    static let selectedColor = AppColors.color07
    static let borderSelectedColor = AppColors.color08
    static let borderColor = AppColors.color03
    static let shadowColor = AppColors.color00.opacity(0.15)
    static let textColor = AppColors.color06
...
struct NodeView: View {
    ...
    var body: some View {
        ...
        .overlay(
            RoundedRectangle(cornerRadius: NodeViewStyle.cornerRadius)
                .stroke(borderColor, lineWidth: NodeViewStyle.borderWidth)
        )
    ...
    private var borderColor: Color {
        switch dragState {
        case .inactive:
            return viewModel.isSelected ? NodeViewStyle.borderSelectedColor : NodeViewStyle.borderColor
        case .dragging:
            return NodeViewStyle.borderSelectedColor
        }
    }
